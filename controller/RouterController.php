 ...
 * User: lyang
 * Date: 1/30/18
 * Router is a special kind of controller (front controller pattern) which calls appropriate
 ...
 * Example:
 *    http://localhost/list will map to ListController
 *    http://localhost/add-sprocket will map to AddSprocketController
 *    http://localhost/remove-all-sprocket will map to RemoveAllSprocketController
 *
...
class RouterController extends AbstractController
{
    ...
    public function process($params)
    {
        ...
        if (empty($parsedUrl[0])) { //Just calling the landing page
